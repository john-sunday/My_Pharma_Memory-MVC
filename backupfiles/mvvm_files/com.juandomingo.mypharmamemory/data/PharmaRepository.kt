package com.juandomingo.mypharmamemorymvc.data

import com.juandomingo.mypharmamemorymvc.data.model.PharmaProvider
import com.juandomingo.mypharmamemorymvc.model.PharmacoModel
import com.juandomingo.mypharmamemorymvc.data.network.PharmaService
...
class PharmaRepository @Inject constructor(
    ...
    *   */
    ...
    fun addNewMyPharma(pharmaco: PharmacoModel) {
